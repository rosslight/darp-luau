...
/// <summary> Defines an immutable array that defines structural equality semantics. </summary>
/// <typeparam name="T">The type of the array elements.</typeparam>
/// <remarks> <see href="https://github.com/dotnet/runtime/issues/77183">Issue regarding equality of arrays</see> </remarks>
/// <remarks> <see href="https://github.com/eiriktsarpalis/PolyType/blob/main/src/PolyType.Roslyn/IncrementalTypes/ImmutableEquatableArray.cs">Original source</see> </remarks>
...
{
    /// <summary> An empty <see cref="ImmutableEquatableArray{T}"/> instance. </summary>
    ...
    public override int GetHashCode() =>
        _values.Aggregate(0, (current, value) => CombineHashCodes(current, value is null ? 0 : value.GetHashCode()));
    ...
    /// <summary> Defines an enumerator for the <see cref="ImmutableEquatableArray{T}"/> type. </summary>
    ...
    internal static ImmutableEquatableArray<T> UnsafeCreateFromArray(T[] values) => new(values);
...
/// <summary> Provides extension methods for the <see cref="ImmutableEquatableArray{T}"/> type. </summary>
internal static class ImmutableEquatableArray
{
    /// <summary> Creates an <see cref="ImmutableEquatableArray{T}"/> instance from the specified values. </summary>
