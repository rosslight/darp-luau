    ...
    where T : class
{
    ...
    /// <returns>
    /// The callback result.
    /// Use <see crefLuauResultSinglene.NotHandled"/> to signal unknown members.
    /// </returns>
    static abstract LuauResultSingle OnIndex(T self, in LuauState state, in ReadOnlySpan<char> fieldName);
    ...
    /// <returns>
    /// The callback result.
    /// Use <see cLuauOutcomeltOne.NotHandled"/> to signal unknown members.
    /// </returns>
