...
Then use the feature pages for the concrete APIs built on top of those rules, especially [Strings](../features/strings.md), [Buffers](../features/buffers.md), callbacks, tables, userdata, modules, and [Require](../features/require.md).
